...
KO = {
    ...
    # 주문을 마치기 전에 수령정보를 그대로 읽어준다. 값은 코드가 넣는다
    "confirm_title": "배송지 확인 부탁드립니다.",
    "confirm_addr": "  주소   %s",
    "confirm_receiver": "  수령인 %s",
    "confirm_phone": "  전화   %s",
    "confirm_tail": "맞으실까요?",
    ...
    "vd_save": "판정 저장",
    "rp_autorate": "자율 완결률",
    "rp_autorate_delta": "%d / %d건",
    "rp_autorate_none": "결과 미기록",
    "rp_outcomes": "### 대화 결과 분포",
    "rp_col_outcome": "결과",
    "vd_outcome": "### 대화 결과",
    "vd_outcome_help": "챗봇 혼자 주문서까지 완성했는지만 봅니다. "
                       "검수 플래그가 떠 있어도 주문서가 완성됐으면 자율 완결입니다.",
    "oc_auto": "자율 완결",
    "oc_handoff": "이관 (사람이 들어가야 했음)",
    "oc_drop": "이탈 (고객이 포기)",
    "vd_convid": "### 대화 ID",
    "vd_convid_help": "테스트 시트의 '대화 ID' 열에 이 값을 그대로 붙여넣어 주세요. "
                      "이 값이 있어야 나중에 이 대화를 그대로 다시 찾을 수 있습니다.",
    ...
    "cause_nodb": "DB에없음",
    "cause_policy": "지침부족",
    "fl_bot_repeat": "챗봇이 사실상 같은 응답을 %d회 연속 반복 — 흐름이 막힘",
    "fl_cust_repeat": "고객이 사실상 같은 말을 %d회 연속 반복 — 챗봇이 못 알아듣는 중",
    "cause_lang": "태국어 수정",
    "cause_etc": "기타",
    ...
    "fl_address_image": "%s 에서 %s 추출 — 육안 확인 필요",
...
TH = {
    ...
    "confirm_title": "รบกวนตรวจสอบข้อมูลจัดส่งด้วยค่ะ",
    "confirm_addr": "  ที่อยู่   %s",
    "confirm_receiver": "  ผู้รับ   %s",
    "confirm_phone": "  เบอร์โทร %s",
    "confirm_tail": "ถูกต้องมั้ยคะ",
    ...
    "rp_autorate": "อัตราจบได้เอง",
    "rp_autorate_delta": "%d / %d รายการ",
    "rp_autorate_none": "ยังไม่มีบันทึกผล",
    "rp_outcomes": "### การกระจายผลของบทสนทนา",
    "rp_col_outcome": "ผล",
    "vd_outcome": "### ผลของบทสนทนา",
    "vd_outcome_help": "ดูเพียงว่าแชตบอตทำใบสั่งซื้อจนจบได้เองหรือไม่ "
                       "แม้จะมีแฟล็กให้ตรวจสอบ ถ้าใบสั่งซื้อเสร็จก็ถือว่าจบได้เอง",
    "oc_auto": "จบได้เอง",
    "oc_handoff": "ส่งต่อเจ้าหน้าที่ (ต้องมีคนเข้ามา)",
    "oc_drop": "ลูกค้าเลิกกลางคัน",
    "vd_convid": "### รหัสบทสนทนา",
    "vd_convid_help": "กรุณาคัดลอกค่านี้ไปวางในคอลัมน์ 'รหัสบทสนทนา' ของชีตทดสอบ "
                      "มีค่านี้แล้วจึงจะย้อนกลับมาดูบทสนทนานี้ได้ภายหลัง",
    ...
    "fl_address_image": "อ่านมาจาก %s ได้ %s — ต้องตรวจด้วยตา",
